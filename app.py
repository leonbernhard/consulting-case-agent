...
def create_docx_report(title, framework, analysis, mece, hypothesis):
    """Erstellt ein professionelles Microsoft Word Dokument (.docx) inklusive KI-Signatur in der Fußzeile."""
    doc = Document()
    ...
    # KI-Signatur & Fußzeile im Word-Dokument
    p_footer = doc.add_paragraph()
    p_footer.paragraph_format.space_before = Pt(30)
    p_footer.alignment = 1  # Zentriert
    run_footer = p_footer.add_run("Generated by AI Consulting & Case Structuring Agent | Confidential & Professional Support Tool")
